...
const LAMDA_2513_CHAIN_SPEC: &[u8] = include_bytes!("../res/chain-spec-raw-lamda-2513.json");
...
pub fn lamda_2513_config(
) -> Result<ConsensusChainSpec<GenesisConfig, ExecutionGenesisConfig>, String> {
    ConsensusChainSpec::from_json_bytes(LAMDA_2513_CHAIN_SPEC)
}

pub fn lamda_2513_compiled(
) -> Result<ConsensusChainSpec<GenesisConfig, ExecutionGenesisConfig>, String> {
    Ok(ConsensusChainSpec::from_genesis(
        ...
        // ID
        "Lamda_2513_3",
        ChainType::Custom("Lamda 2513-3".to_string()),
        || {
            let sudo_account =
